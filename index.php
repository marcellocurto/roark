    ...
    while (have_posts()): the_post();
        ...
        if (!empty($advanced_css_light) || !empty($advanced_css_dark)) {
            if (!empty($advanced_css_light)) {
                $custom_css_light .= '#post-' . $id_of_post . ' {' . $advanced_css_light . '} ';
            }
            if (!empty($advanced_css_dark)) {
                $custom_css_dark .= '#post-' . $id_of_post . ' {' . $advanced_css_dark . '} ';
            }
        } else {
...
<article <?php post_class('post-wrapper');?>
    ...
    <div class="post-part-1">
        ...
        ?>
        <div class="excerpt-wrapper"><?php the_excerpt();?>
        </div>
        ...
        <section class="date-wrapper date-singular">
            <p><?php echo get_the_time('F j Y'); ?>
            </p>
        </section>
        <?php else: ?>
        <div class="date-wrapper">
            <p><?php
            if (get_field('since_check') == 'yes') {
                echo 'since ' . get_the_time('Y');
            } else {
                echo get_the_time('Y');
            }
            ?>
