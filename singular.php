...
<?php
    ...
    $advanced_css_light = get_field('advanced_css_light');
    $advanced_css_dark = get_field('advanced_css_dark');
    
    if (!empty($advanced_css_light) || !empty($advanced_css_dark)) {
        if (!empty($advanced_css_light)) {
            $custom_css_light .= 'html {' . $advanced_css_light . '} body {' . $advanced_css_light . '}';
        }
        if (!empty($advanced_css_dark)) {
            $custom_css_dark .= 'html {' . $advanced_css_dark . '} body {' . $advanced_css_dark . '}';
        }
    } else {
        ...
        if ('top' == $direction_color) {
            $background_html_direction = 'bottom';
        } elseif ('bottom' == $direction_color) {
            $background_html_direction = 'top';
        }
...
<article <?php post_class('post-wrapper single-page');?>
...
?>>
    <section class="title-wrapper">
        <h1 class="title-single-page"><?php the_title();?>
        </h1>
        <?php
$cats = array();
...
?>
    ...
    <div class="contact-wrapper contact-single">
        ...
        <span class="icon-wrapper">
            <a href="<?php echo esc_url(get_field('instagram')); ?>"
                target="_blank">
        ...
        <span class="icon-wrapper">
            <a href="<?php echo esc_url('mailto:' . get_field('email')); ?>"
                target="_blank">
    ...
    <section class="date-wrapper date-singular">
        <p><?php _e('Published on:', 'roark_agency_theme');?>
        </p>
        <p><?php echo get_the_time('F jS Y'); ?>
        </p>
    </section>
    <?php endif;?>
...
<?php else: ?>
<p class="no-posts"><?php _e('Sorry, no posts matched your criteria.', 'roark_agency_theme');?>
</p>
<?php endif;?>
